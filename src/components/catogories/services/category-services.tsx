...
export async function getCategory(): Promise<Category[]> {
  ...
  { title: 'Scrunchies', imageURL: 'https://images.unsplash.com/photo-1685688889049-2244802dcf38?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'},
